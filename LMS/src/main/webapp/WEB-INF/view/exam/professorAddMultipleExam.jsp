...
<body>
			...
			<div class="card mb-4">
				...
				<div class="mt-2 mb-3">
					...
					<div class="mt-2 mb-3">
						...
						<div>
							<input class="form-control" type="text" style="width: 200px"
								placeholder="보기 1번"> <input class="form-control"
								type="text" style="width: 200px" placeholder="보기 2번"> <input
								class="form-control" type="text" style="width: 200px"
								placeholder="보기 3번"> <input class="form-control"
								type="text" style="width: 200px" placeholder="보기 4번">
						</div>
					</div>
					<label>※정답</label> <select id="" class="form-select color-dropdown"
	...
	<div class="">
		...
		<a
			href="${pageContext.request.contextPath}/exam/professorAddExamSubjective/"
			class="btn btn-danger">객관식문제 제출하기</a> <a
			href="javascript:history.back()" class="btn btn-danger">뒤로가기</a>
	</div>
	<hr>
