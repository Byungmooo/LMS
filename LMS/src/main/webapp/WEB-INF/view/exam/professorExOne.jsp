...
<div class="container-xxl flex-grow-1 container-p-y">
	...
	<div class="text-center">
		<h4 class="card-header">
			시험명 : ${examSheet.examName} / ${examSheet.examNo }
		</h4>
	</div>
	<div class="container-xxl flex-grow-1 container-p-y">
		<div class="col-xl-6">
		...
		<form action="${pageContext.request.contextPath}/exam/deleteExamSheet"
			method="post" class="card-body">
			<div class="text-center">
			<a href="${pageContext.request.contextPath}/exam/updateExamSheet/${examSheet.examNo}"
				class="btn btn-primary">시험지수정</a> &nbsp; &nbsp; <input
				type="hidden" name="examNo" value="${examSheet.examNo }">
			<button class="btn btn-primary" onclick="deleteBtn()">시험지삭제</button>
