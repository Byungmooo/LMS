...
<link rel="icon" type="image/x-icon" href="../assets/img/favicon/favicon.ico" />
    ...
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/ssets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="text-center">
                ...
                <a href="${pageContext.request.contextPath}/memberRegister">
                  <span>회원가입</span>
                </a>
              </p>
            </div>
