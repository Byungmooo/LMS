		...
		<div class="layout-container">
			...
			<aside id="layout-menu"
				...
				<div class="app-brand demo">
					...
					</span> <span class="app-brand-text demo menu-text fw-bolder ms-2">LMS</span>
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item">
						<a href="${pageContext.request.contextPath}/employee/employeeOne?employeeCode=${memberCode}" class="menu-link"> 
					...
					<li class="menu-item">
						<a href="${pageContext.request.contextPath}/emplyoee/departmentList" class="menu-link"> 
						...
						<ul class="navbar-nav flex-row align-items-center ms-auto">
							...
							<li class="nav-item navbar-dropdown dropdown-user dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-end">
									...
									<li>
										<a class="dropdown-item" href="${pageContext.request.contextPath}/employee/employeeOne?employeeCode=${memberCode}"> 
