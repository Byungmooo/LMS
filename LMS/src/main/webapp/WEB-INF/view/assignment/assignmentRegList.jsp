...
<div class="container-xxl flex-grow-1 container-p-y">
	...
	<div class="product-status mg-b-15">
		<div class="container-fluid">
			<form
				action="${pageContext.request.contextPath}/student/assignmentRegList"
				method="post">
				<div class="row">
									...
									<table class="table">
										...
										<c:forEach var="a" items="${list}">
											<tr>
												...
												<c:if test="${memberType eq '학생'}">
													<td><a
														href="${pageContext.request.contextPath}/student/assignmentRegOne?assignmentRegNo=${a.assignmentRegNo}&openedLecNo=${openedLecNo}"
														style="float: bottom;"> ${a.assignmentRegTitle}</a></td>
												</c:if>
												<c:if test="${memberType eq '교수'}">
													<td><a
														href="${pageContext.request.contextPath}/professor/assignmentRegOne?assignmentRegNo=${a.assignmentRegNo}&openedLecNo=${openedLecNo}"
														style="float: bottom;"> ${a.assignmentRegTitle}</a></td>
												</c:if>
