...
<div class="container-xxl flex-grow-1 container-p-y">
	...
	<div class="card text-center" style="margin-top: 20px;">
		<h5 class="card-header"><strong>전체게시판</strong></h5>
	...
	<div class="row">
		...
		<div class="col-sm-7 col-12 text-center">
			<form
				action="${pageContext.request.contextPath}/member/totalNoticeList"
				method="get">
				...
				<ul class="pagination justify-content-center">
					<c:if test="${paging.prePage}">
						<li class="page-item prev"><a class="page-link"
							href="${pageContext.request.contextPath}/member/totalNoticeList?currentPage=${paging.currentPage-1}
						...
						<c:choose>
							...
							<c:when test="${p != paging.currentPage }">
								<li class="page-item"><a class="page-link"
									href="${pageContext.request.contextPath}/member/totalNoticeList?currentPage=${p}
