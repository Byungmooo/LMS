	...
	<div class="container-xxl flex-grow-1 container-p-y">
		...
		<div class="row text-center">
			<div class="card">
				...
				<div class="card-body">
		                <form name="form" action="${pageContext.request.contextPath}/addLecNotice" method="post">
                    <input type="hidden" name="writer" value="테스트">
<%--                    <input type="hidden" name="memberId" value="${session.id}">--%>

                    <div>
                        제목
                        <input name="lecNoticeTitle" id="title" size="80" value="" placeholder="제목을 입력해주세요">
                    </div>
                    <div>
                        내용
                        <textarea name="lecNoticeContent" id="content" rows="4" cols="80"
