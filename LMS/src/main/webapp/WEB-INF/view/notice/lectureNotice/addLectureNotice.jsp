				...
				<div class="card-body">
					<form name="form" action="${pageContext.request.contextPath}/professor/addLectureNotice" method="post" id="addLecNoticeForm">
						<table class="table table-bordered">
							...
							<tr>
								<th>제목</th>
								<td colspan="3"><input type="text" class="form-control"  name="noticeTitle" id="noticeTitle" class="form-control">
								</td>
							</tr>
							<tr>
								<th>공지내용</th>
								<td colspan="3"><textarea  class="form-control" name="noticeContent" id="noticeContent" class="form-control" rows="10px"></textarea>
								</td>
							</tr>
						</table>
