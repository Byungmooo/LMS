...
<div class="container-xxl flex-grow-1 container-p-y">
				...
				<div class="d-flex align-items-end row">
					...
					<div class="col-sm-5 text-center text-sm-left">
						<div class="card-body pb-0 px-0 px-md-4">
							<img src="${pageContext.request.contextPath}/imgFile/lecture.png" height="140"
								alt="View Badge User"
	...
	<div class="row text-center">
		<div class="card">
			<h5 class="card-header"><strong>질문수정</strong></h5>
			<div class="card-body">
				<form name="form"
					action="${pageContext.request.contextPath}/student/updateLectureQuestion"
					method="post">
					<table class="table table-bordered">
						...
						<tr>
							<th>제목</th>
							<td colspan="7"><input class="form-control"
								name="noticeTitle" id="title" size="115"
								value="${question.noticeTitle}" placeholder="제목을 입력해주세요">
						...
						<tr>
							...
							<td colspan="7"><textarea class="form-control" rows="10px"
									name="noticeContent" id="content" rows="4" cols="80"
