...
<c:choose>
	...
	<div class="container-xxl flex-grow-1 container-p-y">
		...
		<div class="row text-center">
			<div class="card">
				<h5 class="card-header"><strong>강의 질문</strong></h5>
				<hr class="my-0" />
				
				<div class="card-body">
		                <form name="form" action="${pageContext.request.contextPath}/student/addLectureQuestion" method="post">
...
<%--                    <input type="hidden" name="memberId" value="${session.id}">--%>
                 ...
                 <div style="width:650px; text-align: center;">
                        <button class="btn btn-danger" type="button" id="btnAdd">질문등록</button>
