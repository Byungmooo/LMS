	...
	<div class="col-sm-12 col-12 text-center">
					...
					<tbody>
						<c:forEach var="d" items="${list}">
							<tr>
								...
								<td><a
									href="${pageContext.request.contextPath}/emplyoee/departmentOne?departmentCode=${d.departmentCode}">${d.departmentName}</a>
								</td>
								<td>${d.createDate}</td>
							</tr>
						</c:forEach>
		...
		<div class="row">
			...
			<div class="col-sm-7 col-12 text-center">
				<form
					action="${pageContext.request.contextPath}/emplyoee/departmentList"
					method="get">
					...
					<ul class="pagination justify-content-center">
						<c:if test="${paging.prePage}">
							<li class="page-item prev"><a class="page-link"
								href="${pageContext.request.contextPath}/emplyoee/departmentList?currentPage=${paging.currentPage-1}
							...
							<c:choose>
								...
								<c:when test="${p != paging.currentPage }">
									<li class="page-item"><a class="page-link"
										href="${pageContext.request.contextPath}/emplyoee/departmentList?currentPage=${p}
