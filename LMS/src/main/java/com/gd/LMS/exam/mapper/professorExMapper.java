...
public interface professorExMapper {
	...
	// 시험지추가하기
	int insertExamSheet(ExamSheet examSheet);

	//// 객관식문제추가하기
	int insertMultiple(Map<String, Object> params);
	////객관식 보기 추가하기
	int insertExample(Map<String, Object> params);

	// 강좌번호
	int selectMultipleChoiceListCount(int openedLecNo);
	...
	// 주관식 문제 등록
	int insertSubjective(Map<String, Object> params);
